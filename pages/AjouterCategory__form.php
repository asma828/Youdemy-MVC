    ...
    <div class="container">
        <div class="form-container">
            <div class="d-flex justify-content-between align-items-center mb-4">
                ...
                <e class="page-title mb-0">Ajouter Un categorie</e>
            </div>

            <form id="courseForm" method="POST" action="../actions/AjouterCategory_action.php">
                <div id="group_inputs">
                ...
                <div class="d-flex justify-content-between align-items-center mt-4">
                    <button type="submit" class="btn btn-primary">
                        <i class="fas fa-save me-2"></i>Enregistrer la categorie
                    </button>
                </div>
            </form>
        </div>
