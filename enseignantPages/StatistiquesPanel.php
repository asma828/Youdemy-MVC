...
<body class="bg-gray-50">
    ...
    <main class="ml-64 p-8">
        ...
        <div class="flex justify-between items-center mb-8">
            <h2 class="text-2xl font-bold">Tableau de bord Enseignant</h2>
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-6 mb-8">
            ...
            <div class="bg-white p-6 rounded-lg shadow-sm hover:shadow-lg transition-shadow">
                <div class="flex items-center space-x-4">
                    ...
                    <div>
                        ...
                        <p class="text-3xl font-bold text-blue-600"><?= $countTotalEtudiantsInscrits ?></p>
                    </div>
                </div>
            </div>
            ...
            <div class="bg-white p-6 rounded-lg shadow-sm hover:shadow-lg transition-shadow">
                <div class="flex items-center space-x-4">
                    ...
                    <div>
                        <p class="text-gray-600">Total des cours</p>
                        <p class="text-3xl font-bold text-blue-600"><?= $countTotalCours ?></p>
                    </div>
                </div>
            </div>
        </div>
